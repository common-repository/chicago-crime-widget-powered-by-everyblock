...
Tags: widgets, everyblock, widget, crime, chicago, illinois
Tested up to: 3.6.1
...
Add a Chicago Crime Widget Powered by Everyblock to a post or page.  Will also allow you to add as a widget.
...
2. On the plugins page in the dashboard, click the "Activate" button under "Chicago Crime Widget Powered by Everyblock".
...
5. If you want to embed in a post, use the shortcode [embed_chicago_crime_widget].  This will add a 300x500 widget.  You can specify sizes by adding the attributes width and height (example: [embed_chicago_crime_widget width=400 height=600]).
6. If you want to add as a widget, drag the widget labeled "Chicago Crime Widget" to the appropriate location.  You can change the height or width.
...
After activating the plugin, add the shortcode [embed_chicago_crime_widget] to any page or post.  

= How do I change the width and height of the widget while it is embedded in a page or post? =

Add the shortcode attributes width and height.  Example: [embed_chicago_crime_widget width=400 height=600].

= How do I add the crime widget to a sidebar, header, or footer? =

After activating the plugin, go to Appearance -> Settings, and drag the "Chicago Crime Widget" to the appropriate area. 
...
= 2.0.2 =
* Changed shortcode to [embed_chicago_crime_widget].
